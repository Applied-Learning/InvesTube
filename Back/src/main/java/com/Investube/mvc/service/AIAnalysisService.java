...
public class AIAnalysisService {
    ...
    public AiAnalysisResult analyzeFinancials(
        ...
        try {
            ...
            // 2. AI 프롬프트 생성
            String prompt = promptBuilder.buildFinancialAnalysisPrompt(
                    stockCode,
                    stockName,
                    financialData,
                    baseScore,
            ...
            // 3. OpenAI GPT API 호출
            String aiResponse = openaiClient.callGPT(prompt);
    ...
    public String chat(String userMessage, String context) {
        try {
            String prompt = promptBuilder.buildChatPrompt(userMessage, context);
            return openaiClient.callGPT(prompt);
        } catch (Exception e) {
